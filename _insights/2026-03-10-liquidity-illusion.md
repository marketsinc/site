...
authors:
  - name: Dean Eigenmann
permalink: "/insights/liquidity-illusion"
description: "Before asking whether a protocol should return capital, we should first ask who the marginal buyer is. In crypto, the buy side is thin and the sell side is enormous and obligated."
